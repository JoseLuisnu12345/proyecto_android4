...
public class TareaUsuarioListAdapter extends BaseAdapter {

    private Context context;
    private List<Tarea> tareas;

    public TareaUsuarioListAdapter(Context context, List<Tarea> tareas)
    {
    ...
    public View getView(int i, View view, ViewGroup parent) {
        ...
        //Técnico:
        lbUsuario.setText("Técnico: " + tarea.getUsuarioAsignado().getNombre());
        //lbCategoria
